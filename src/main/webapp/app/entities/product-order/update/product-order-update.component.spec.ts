...
describe('ProductOrder Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      ...
      const product: IProduct = { id: 3560 };
      productOrder.product = product;

      const productCollection: IProduct[] = [{ id: 27093 }];
    ...
    it('Should call ShoppingCart query and add missing value', () => {
      const productOrder: IProductOrder = { id: 456 };
      const cart: IShoppingCart = { id: 13052 };
      productOrder.cart = cart;

      const shoppingCartCollection: IShoppingCart[] = [{ id: 28903 }];
    ...
    it('Should update editForm', () => {
      const productOrder: IProductOrder = { id: 456 };
      const product: IProduct = { id: 12097 };
      productOrder.product = product;
      const cart: IShoppingCart = { id: 23154 };
      productOrder.cart = cart;
