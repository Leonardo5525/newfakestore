...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'besides victoriously' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('longingly emu buddy');
      cy.get(`[data-cy="name"]`).should('have.value', 'longingly emu buddy');

      cy.get(`[data-cy="description"]`).type('too pish');
      cy.get(`[data-cy="description"]`).should('have.value', 'too pish');
