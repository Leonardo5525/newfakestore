...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'athletic', price: 13579.35, productSize: 'L' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: { name: 'consequently upward as', description: 'affiliate why beyond' },
    }).then(({ body }) => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('reproachfully above');
      cy.get(`[data-cy="name"]`).should('have.value', 'reproachfully above');

      cy.get(`[data-cy="description"]`).type('gadzooks divide prohibition');
      cy.get(`[data-cy="description"]`).should('have.value', 'gadzooks divide prohibition');

      cy.get(`[data-cy="price"]`).type('7390.99');
      cy.get(`[data-cy="price"]`).should('have.value', '7390.99');
